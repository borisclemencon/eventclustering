package com.clemencb.eventclustering.naive.runable
...
import com.clemencb.eventclustering.naive.session.{Session, WebsiteVisit}

import scala.io.Source

object Main extends App {

  def processCsvLine(s:String, sep:String=",") : WebsiteVisit = {
    val res = s.split(sep)
